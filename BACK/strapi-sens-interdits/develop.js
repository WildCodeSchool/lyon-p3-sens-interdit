...
const loadConfiguration = require('./node_modules/strapi/lib/core/app-configuration');
 ...
 *
 */
const develop = async function({ build, watchAdmin, browser }) {
...
module.exports = develop({build: true, watchAdmin: true, browser: ''});
/**
