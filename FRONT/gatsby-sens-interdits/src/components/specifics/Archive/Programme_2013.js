...
function Programme2013(props) {
  const { allStrapiArchivesOld } = useStaticQuery(graphql`
    query MyQueryArchive2013 {
      allStrapiArchivesOld(filter: { annee: { eq: "2013" } }) {
        edges {
          node {
            titre
            strapiId
    ...
    <>
      ...
      <div className="global-margin archive-global-styling">
        ...
        <h1 className="to-uppercase">
          Découvrez <span>les archives du festival 2013</span>
        </h1>
