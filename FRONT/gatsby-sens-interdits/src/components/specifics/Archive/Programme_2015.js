...
function Programme2015(props) {
  const { allStrapiArchivesOld } = useStaticQuery(graphql`
    query MyQueryArchive2015 {
      allStrapiArchivesOld(filter: { annee: { eq: "2015" } }) {
        edges {
          node {
            titre
            strapiId
    ...
    <>
      ...
      <div className="global-margin archive-global-styling">
        ...
        <h1 className="to-uppercase">
          Découvrez <span>les archives du festival 2015</span>
        </h1>
