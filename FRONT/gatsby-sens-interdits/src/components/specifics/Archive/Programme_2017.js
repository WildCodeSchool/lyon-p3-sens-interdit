...
function Programme2017(props) {
  const { allStrapiArchivesOld } = useStaticQuery(graphql`
    query MyQueryArchive2017 {
      allStrapiArchivesOld(filter: { annee: { eq: "2017" } }) {
        edges {
          node {
            titre
            strapiId
    ...
    <>
      ...
      <div className="global-margin archive-global-styling">
        ...
        <h1 className="to-uppercase">
          Découvrez <span>les archives du festival 2017</span>
        </h1>
