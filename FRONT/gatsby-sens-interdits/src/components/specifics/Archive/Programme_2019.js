...
function Programme2019(props) {
  const { allStrapiArchivesOld } = useStaticQuery(graphql`
    query MyQueryArchive2019 {
      allStrapiArchivesOld(filter: { annee: { eq: "2019" } }) {
        edges {
          node {
            titre
            strapiId
    ...
    <>
      ...
      <div className="global-margin archive-global-styling">
        ...
        <h1 className="to-uppercase">
          Découvrez <span>les archives du festival 2019</span>
        </h1>
