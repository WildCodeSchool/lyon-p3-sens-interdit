...
function Programme2009(props) {
  const { allStrapiArchivesOld } = useStaticQuery(graphql`
    query MyQueryArchive2009 {
      allStrapiArchivesOld(filter: { annee: { eq: "2009" } }) {
        edges {
          node {
            titre
            strapiId
    ...
    <>
      ...
      <div className="global-margin archive-global-styling">
        ...
        <h1 className="to-uppercase">
          Découvrez <span>les archives du festival 2009</span>
        </h1>
